...
@RestController
@RequestMapping("/api/pedagogico-kafka")
public class PedagogicoKafkaResource {

    private final Logger log = LoggerFactory.getLogger(PedagogicoKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public PedagogicoKafkaResource(KafkaProperties kafkaProperties) {
