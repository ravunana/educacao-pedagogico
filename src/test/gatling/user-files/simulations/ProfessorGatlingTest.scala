...
class ProfessorGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Professor entity")
        ...
        .repeat(2) {
            ...
            .get("/services/pedagogico/api/professors")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new professor")
            .post("/services/pedagogico/api/professors")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "nome":"SAMPLE_TEXT"
            ...
            .repeat(5) {
                ...
                .get("/services/pedagogico${new_professor_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created professor")
            .delete("/services/pedagogico${new_professor_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
