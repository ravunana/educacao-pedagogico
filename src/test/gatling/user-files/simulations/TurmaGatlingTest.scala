...
class TurmaGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Turma entity")
        ...
        .repeat(2) {
            ...
            .get("/services/pedagogico/api/turmas")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new turma")
            .post("/services/pedagogico/api/turmas")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                ...
                , "abertura":"2020-01-01T00:00:00.000Z"
                , "encerramento":"2020-01-01T00:00:00.000Z"
                , "lotacao":"0"
                , "aberta":null
            ...
            .repeat(5) {
                ...
                .get("/services/pedagogico${new_turma_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created turma")
            .delete("/services/pedagogico${new_turma_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
