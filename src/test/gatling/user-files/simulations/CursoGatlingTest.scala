...
class CursoGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Curso entity")
        ...
        .repeat(2) {
            ...
            .get("/services/pedagogico/api/cursos")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new curso")
            .post("/services/pedagogico/api/cursos")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "nome":"SAMPLE_TEXT"
            ...
            .repeat(5) {
                ...
                .get("/services/pedagogico${new_curso_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created curso")
            .delete("/services/pedagogico${new_curso_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
